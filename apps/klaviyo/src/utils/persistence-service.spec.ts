...
describe('persistence-service', () => {
  ...
  describe('getSyncData', () => {
    ...
    it('should handle errors and return empty array', async () => {
      ...
      mockSessionStorage.getItem.mockImplementation(() => { throw mockError; });
  ...
  describe('updateSyncData', () => {
    ...
    it('should log message in config location', async () => {
      ...
      // Assert
      expect(consoleSpy).toHaveBeenCalled();
      expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('Config data will be saved'), expect.anything());
    ...
    it('should handle errors during storage update', async () => {
      ...
      const mockError = new Error('Test error');
      mockSessionStorage.setItem.mockImplementation(() => { throw mockError; });
