      ...
      <React.Fragment>
        <Flex className={styles.background}>
            ...
            {!this.props.accessToken && <Flex flexDirection='column' className={styles.body}>
              ...
              <Button variant='primary' onClick={this.connectToWingify} isLoading={this.state.loading}>Connect with Wingify</Button>
            </Flex>}
            {/* After connecting to Wingify */}
