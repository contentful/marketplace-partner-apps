        ...
        {() => (
          <>
            ...
            <Modal.Content>
              <Form onSubmit={() => props.onModalClose(state)}>
                <FormControl className={styles.fieldItem}>
                  ...
                  <TextInput value={state.flagName} maxLength="255" onChange={(e) => dispatch(setFlagName(e.target.value))} />
                  <Grid columns="auto 80px">
                    <FormControl.HelpText>Name should be no longer than 255 characters</FormControl.HelpText>
                    <FormControl.Counter />
                  </Grid>
                </FormControl>
                <FormControl className={styles.fieldItem}>
                  <FormControl.Label>Description</FormControl.Label>
                  <Textarea value={state.description} maxLength="300" onChange={(e) => dispatch(setDescription(e.target.value))} />
                  <Grid columns="auto 80px">
                    <FormControl.HelpText>Description should be no longer than 300 characters</FormControl.HelpText>
                    <FormControl.Counter />
                  </Grid>
                </FormControl>
              </Form>
            ...
            <ModalControls>
              ...
              <Button size="small" variant="positive" isLoading={props.loading} isDisabled={!madeChanges()} onClick={() => props.onModalClose(state)}>
                Save
              </Button>
            </ModalControls>
          </>
