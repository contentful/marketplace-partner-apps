    ...
    <React.Fragment>
      <div className={styles.container}>
        <Flex alignItems="center">
          <Heading element="h1" marginBottom="0px" marginRight="spacingXs">
          ...
          <FormControl className={styles.fieldItem}>
            ...
            <Stack flexDirection="row">
              <Radio
                ...
                onChange={() => dispatch(setType(FlagTypes.TEMPORARY))}>
                Temporary
              </Radio>
              <Radio
                id="flag-type2"
                ...
                onChange={() => dispatch(setType(FlagTypes.PERMANENT))}>
                Permanent
              </Radio>
            </Stack>
          </FormControl>
          <Button variant="primary" size="small" onClick={createFeatureFlag} isDisabled={isDisabled} isLoading={state.loading} className={styles.button}>
            Create feature flag
          </Button>
        </Form>
      </div>
