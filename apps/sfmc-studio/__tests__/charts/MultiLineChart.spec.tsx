...
describe('MultiLineChart', () => {
  ...
  it('correctly formats tooltip values', () => {
    ...
    const tooltipFunc = actualConfig.tooltip as (d: any, index: number, data: any[]) => any;
  ...
  it('formats x-axis labels correctly when dateShow is true', () => {
    ...
    expect(xAxisStyle?.labelFormatter('2024-01-01', 0, defaultProps.data, {})).toContain('01 Jan 2024');
  });
});
