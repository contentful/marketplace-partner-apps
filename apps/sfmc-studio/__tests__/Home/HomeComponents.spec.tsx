...
jest.mock('../../src/app/components/Locations/Field', () => () => <div>Field Component</div>);
jest.mock('../../src/app/components/Locations/EntryEditor', () => () => <div>EntryEditor Component</div>);
jest.mock('../../src/app/components/Locations/Dialog', () => () => <div>Dialog Component</div>);
jest.mock('../../src/app/components/Locations/Sidebar', () => () => <div>Sidebar Component</div>);
jest.mock('../../src/app/components/Locations/Page', () => () => <div>Page Component</div>);
jest.mock('../../src/app/components/Locations/Home', () => () => <div>Home Component</div>);
...
describe('HomeComponent', () => {
  it('renders Field component when location is LOCATION_ENTRY_FIELD', () => {
    ...
    expect(screen.getByText((content) => content.includes('Home Component'))).toBeInTheDocument();
  });
  ...
  it('renders EntryEditor component when location is LOCATION_ENTRY_EDITOR', () => {
    ...
    expect(screen.getByText((content) => content.includes('EntryEditor Component'))).toBeInTheDocument();
  });
  ...
  it('renders Dialog component when location is LOCATION_DIALOG', () => {
    ...
    expect(screen.getByText((content) => content.includes('Dialog Component'))).toBeInTheDocument();
  });
  ...
  it('renders Sidebar component when location is LOCATION_ENTRY_SIDEBAR', () => {
    ...
    expect(screen.getByText((content) => content.includes('Sidebar Component'))).toBeInTheDocument();
  });
