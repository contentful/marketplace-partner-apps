import { getAcquisitionCounts } from '@/controllers/customer-acquisition/customer-acquisition';
...
export async function POST(
  ...
  try {
    ...
    const customerAcquisitionRes = await getAcquisitionCounts(requestBody);
