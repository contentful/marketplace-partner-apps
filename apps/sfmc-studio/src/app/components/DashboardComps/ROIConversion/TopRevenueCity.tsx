          ...
          {!revenueCity?.length ? (
            ...
            <div className={style.CanvesDataGrapInner}>
              <div className={style.CanvesGrapInner}>
                {revenueCity?.length ? (
                  <PieChartWithRadius data={revenueCity} angleField="revenue" colorField="name" innerRadius={0} width={200} height={250} />
                ) : (
                  ''
                )}
              </div>
              <div className={`${style.CanvesDataTable} ${style.CanvesDataTableWithOddEven}`}>
