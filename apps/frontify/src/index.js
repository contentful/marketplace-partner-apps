...
setup({
  ...
  logo,
  color: '#363D4A',
  description: 'The Frontify app enables editors to access all digital brand assets in Frontify directly from Contentful.',
...
async function openDialog(sdk) {
  ...
  return result.map((item) => ({
    ...
    dynamic_url: item.dynamicPreviewUrl,
    src: item.previewUrl,
