...
import { CreateEntryLinkButton } from '../../components/CreateEntryLinkButton/CreateEntryLinkButton';
import { NoLinkPermissionsInfo } from '../../components/LinkActions/NoLinkPermissionsInfo';
import * as styles from '../../components/LinkActions/styles';
import { ContentEntityType, ContentType, ActionLabels, NavigatorSlideInfo } from '../../types';
        ...
        <>
          ...
          {props.entityType === 'Asset' && (
            <Button
              ...
              testId={testIds.createAndLink}
              onClick={() => props.onCreate(undefined, props.itemsLength).catch(console.error)}
              variant="secondary"
              startIcon={<PlusIcon />}
              size="small"
            >
