...
import { EditorPermissions } from '../field-editor-reference/common/useEditorPermissions';
import { LinkActionsProps } from '../field-editor-reference/components/LinkActions/LinkActions';
...
export function useLinkActionsProps(props: LinkEntityActionsProps): LinkActionsProps {
  ...
  const onCreate = React.useCallback(
    ...
    [entityType, onCreated, sdk.navigator],
  );
  ...
  const onLinkExisting = React.useCallback(
    ...
    [editorPermissions, entityType, onLinkedExisting, props.excludedContentTypes, sdk],
  );
  ...
  const filteredContentTypes = React.useMemo(() => {
    return editorPermissions.creatableContentTypes.filter((contentType) => {
      return !props.excludedContentTypes.includes(contentType.sys.id);
    });
  }, [editorPermissions.creatableContentTypes, props.excludedContentTypes]);
