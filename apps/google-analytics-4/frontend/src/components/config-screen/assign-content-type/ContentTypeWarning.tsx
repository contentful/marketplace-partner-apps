...
const ContentTypeWarning = (props: Props) => {
  const { contentTypeId, slugField, isSaved, isInSidebar, isContentTypeInOptions, isSlugFieldInOptions } = props;
  ...
  }, [contentTypeId, slugField, isSaved, isInSidebar, isContentTypeInOptions, isSlugFieldInOptions]);

  return <WarningDisplay warningType={warningType} tooltipContent={tooltipContent} className={styles.statusItem} />;
};
