...
export default function MapAccountPropertySection(props: Props) {
  const { accountsSummaries, parameters, mergeSdkParameters, onIsValidAccountProperty, originalPropertyId, isApiAccessLoading } = props;
    ...
    <Stack spacing="spacingL" flexDirection="column" alignItems="flex-start">
      <div>
        ...
        <Paragraph marginBottom="none">
          In the dropdown below, select the Google Analytics 4 property that's connected to the website where your content appears.
        </Paragraph>
      </div>
