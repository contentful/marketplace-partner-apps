...
describe('Service Account Checklist', () => {
  ...
  it('installed with invalid service account', () => {
    render(
      <ServiceAccountChecklist
        ...
        adminApiCheck={{
          ...getAdminApiErrorChecklistStatus(false, parameters, invalidServiceAccountError, undefined),
        }}
        dataApiCheck={{
          ...getDataApiErrorChecklistStatus(false, parameters, invalidServiceAccountError, undefined),
        }}
        ga4PropertiesCheck={{
          ...getGa4PropertyErrorChecklistStatus(false, invalidServiceAccountError, undefined, undefined),
        }}
      />
    );
    ...
    expect(screen.getAllByText(/Provide a valid service account key to run this check/)).toHaveLength(3);
  });
  ...
  it('installed with invalid service account key', () => {
    render(
      <ServiceAccountChecklist
        ...
        adminApiCheck={{
          ...getAdminApiErrorChecklistStatus(false, parameters, invalidServiceAccountKeyError, undefined),
        }}
        dataApiCheck={{
          ...getDataApiErrorChecklistStatus(false, parameters, invalidServiceAccountKeyError, undefined),
        }}
        ga4PropertiesCheck={{
          ...getGa4PropertyErrorChecklistStatus(false, invalidServiceAccountKeyError, undefined, undefined),
        }}
      />
    );
  ...
  it('missing service account key', () => {
    render(
      <ServiceAccountChecklist
        ...
        adminApiCheck={{
          ...getAdminApiErrorChecklistStatus(false, parameters, missingServiceAccountKeyFileError, undefined),
        }}
        dataApiCheck={{
          ...getDataApiErrorChecklistStatus(false, parameters, missingServiceAccountKeyFileError, undefined),
        }}
        ga4PropertiesCheck={{
          ...getGa4PropertyErrorChecklistStatus(false, missingServiceAccountKeyFileError, undefined, undefined),
        }}
      />
    );

    // Service account message
    expect(screen.getByText(/Unable to retrieve your stored service account key/)).toBeInTheDocument();
    // Message for other three checks
    expect(screen.getAllByText(/Provide a valid service account key to run this check/)).toHaveLength(3);
  });
  ...
  it('first time install with invalid service account key', () => {
    render(
      <ServiceAccountChecklist
        ...
        adminApiCheck={{
          ...getAdminApiErrorChecklistStatus(true, parameters, invalidServiceAccountError, undefined),
        }}
        dataApiCheck={{
          ...getDataApiErrorChecklistStatus(true, parameters, invalidServiceAccountError, undefined),
        }}
        ga4PropertiesCheck={{
          ...getGa4PropertyErrorChecklistStatus(true, invalidServiceAccountError, undefined, undefined),
        }}
      />
    );
  ...
  it('invalid service account when admin and data apis are not enabled', () => {
    render(
      <ServiceAccountChecklist
        ...
        adminApiCheck={{
          ...getAdminApiErrorChecklistStatus(true, parameters, invalidServiceAccountError, adminApiError),
        }}
        dataApiCheck={{
          ...getDataApiErrorChecklistStatus(true, parameters, invalidServiceAccountError, dataApiError),
        }}
        ga4PropertiesCheck={{
          ...getGa4PropertyErrorChecklistStatus(true, invalidServiceAccountError, adminApiError, undefined),
        }}
      />
    );
    ...
    // Property message
    expect(screen.getByText(/Enable Google Analytics Admin API to run this check/)).toBeInTheDocument();
  });
  ...
  it('has no found GA4 Accounts or Properties', () => {
    ...
    expect(screen.getByText(/Service account doesn't have access to a Google Analytics 4 property/)).toBeInTheDocument();
