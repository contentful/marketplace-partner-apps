...
export const INVALID_ARGUMENT_MSG = 'Invalid arguments provided. Please ensure you have configured your property correctly on the app configuration page.';
export const PERMISSION_DENIED_MSG = 'Permission denied. Please either enable your Google Analytics Data API or ensure you have valid permissions.';
export const INVALID_SERVICE_ACCOUNT = 'Invalid service key. Please ensure you have configured your service account correctly on the app configuration page.';
