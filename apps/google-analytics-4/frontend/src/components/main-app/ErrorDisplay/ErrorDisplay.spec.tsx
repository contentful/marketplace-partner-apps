...
import { DEFAULT_ERR_MSG, INVALID_ARGUMENT_MSG, INVALID_SERVICE_ACCOUNT, PERMISSION_DENIED_MSG } from '../constants/noteMessages';
...
describe('ErrorDisplay', () => {
  ...
  it('mounts with correct msg when error is of type InvalidServiceAccount', async () => {
    ...
    const warningMsg = await findByText(INVALID_SERVICE_ACCOUNT.replace(HYPER_LINK_COPY, '').trim());
    const hyperLink = getByTestId('cf-ui-text-link');
