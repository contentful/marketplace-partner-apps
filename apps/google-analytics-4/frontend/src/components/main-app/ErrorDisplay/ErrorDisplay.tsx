...
import { INVALID_ARGUMENT_MSG, PERMISSION_DENIED_MSG, INVALID_SERVICE_ACCOUNT } from 'components/main-app/constants/noteMessages';
...
type HyperLinkErrorDisplays = 'supportHyperLink' | 'appConfigPageHyperLink' | 'invalidServiceAccount';
...
const ErrorDisplay = (props: Props) => {
  ...
  return <Note body={hyperLinkErrorDisplays[errorBody as HyperLinkErrorDisplays] ?? errorBody} variant="negative" />;
};
