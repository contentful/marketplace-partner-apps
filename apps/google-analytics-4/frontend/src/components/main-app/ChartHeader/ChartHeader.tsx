...
const ChartHeader = (props: Props) => {
  ...
  return (
    <Flex justifyContent="space-between" alignItems="flex-end" marginBottom="spacingS" id="chart-header">
      <Box>
      ...
      <Select className={styles.root} id="daterange" name="daterange" value={dateSelection} onChange={handleOnChange}>
