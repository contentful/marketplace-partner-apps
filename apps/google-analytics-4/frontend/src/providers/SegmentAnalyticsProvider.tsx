...
export const SegmentAnalyticsContext = createContext<{ segmentAnalytics: AnalyticsBrowser | null }>({ segmentAnalytics: null });
...
export const SegmentAnalyticsProvider = (props: { children: ReactNode }) => {
  ...
  return <SegmentAnalyticsContext.Provider value={{ segmentAnalytics }}>{props.children}</SegmentAnalyticsContext.Provider>;
};
