...
export async function fetchFromApi<T>(apiUrl: URL, schema: z.ZodTypeAny, appDefinitionId: string, cma: PlainClientAPI, headers: Headers = {}): Promise<T> {
...
async function fetchResponse(url: URL, appDefinitionId: string, cma: PlainClientAPI, headers: Headers): Promise<Response> {
  try {
