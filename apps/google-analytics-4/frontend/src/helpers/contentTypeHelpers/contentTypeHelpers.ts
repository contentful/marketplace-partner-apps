...
export const generateEditorInterfaceAssignments = (
  ...
  const assignmentsToAdd = contentTypeIds.reduce((acc: EditorInterfaceAssignment, contentTypeId) => {
...
export const sortAndFormatAllContentTypes = (contentTypeItems: ContentTypeProps[]): AllContentTypes => {
