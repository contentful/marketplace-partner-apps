...
describe('externalUrlHelpers', () => {
  it('generates the correct URL with params', () => {
    ...
    expect(result).toEqual(`${BASE_URL}${mockPropertySegment}${mockPagePathSegment}${mockDateSegment}${mockFinalSegment}`);
  });
  ...
  it('generates the property report URL with only a page path filter', () => {
    ...
    expect(result).toEqual(`${BASE_URL}${mockPropertySegment}${mockPagePathSegment}${mockFinalSegment}`);
  });
  ...
  it('generates the property report URL with only a date filter', () => {
    ...
    expect(result).toEqual(`${BASE_URL}${mockPropertySegment}${mockDateSegment}${mockFinalSegment}`);
  });
