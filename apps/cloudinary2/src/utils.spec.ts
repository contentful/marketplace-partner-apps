...
const baseAsset: CloudinaryAsset = {
  url: 'http://images.my-domain.com/image/upload/f_auto/q_auto/v1779450624/SPARK_RC_SCOTT_BIKE_TECH_0125.jpg',
  secure_url: 'https://images.my-domain.com/image/upload/f_auto/q_auto/v1779450624/SPARK_RC_SCOTT_BIKE_TECH_0125.jpg',
  tags: [],
  type: 'upload',
  bytes: 1,
  width: 4000,
...
describe('getDeliveryHostname', () => {
  it('returns custom delivery hostnames', () => {
    expect(getDeliveryHostname('https://images.my-domain.com/image/upload/test')).toBe('images.my-domain.com');
  });
...
describe('buildDeliveryUrl', () => {
  it('builds edited URLs on the configured CNAME', () => {
    ...
    expect(url).toContain('images.my-domain.com');
...
describe('createEditedAsset', () => {
  it('preserves original URLs on the first edit and uses the CNAME for delivery', () => {
    ...
    expect(edited.secure_url).toContain('images.my-domain.com');
    expect(edited.url).toContain('images.my-domain.com');
