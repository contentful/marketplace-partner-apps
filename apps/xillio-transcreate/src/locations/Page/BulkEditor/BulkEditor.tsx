...
export const BulkEditorComponent = ({
    ...
    const hasValidStatus = (validStatuses: TaskStatus[]) => {
        ...
        return [...selected].some((entryId) =>
            tasksByEntryId[entryId]?.some((task) => validStatuses.includes(task.status)),
        );
    };
    ...
    return (
        <Flex flexDirection="column" padding="spacingS" gap="spacingS">
            <div>
                ...
                <DocsLink
                    path="/bulk-editor"
                    style={{ width: "100%", justifyContent: "flex-end", marginTop: tokens.spacingXs }}
                >
                ...
                <Table.Head>
                    <Table.Row>
                        ...
                        <Table.Cell
                            ...
                            sortDirection={
                                entrySorting.column === "sys.updatedAt" ? entrySorting.direction : undefined
                            }
                        >
                            Updated
                        </Table.Cell>
                    ...
                    {!entries ? (
                        ...
                        entries
                            ...
                            .map((entry) => (
                                <Table.Row
                                    key={entry.sys.id}
                                    onClick={() => onOpenEntry(entry.sys.id)}
