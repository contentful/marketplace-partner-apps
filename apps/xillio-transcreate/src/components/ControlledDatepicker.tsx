...
export const ControlledDatepicker = <T extends FieldValues>({ label, helpText, isRequired, ...props }: ControlledDatepickerProps<T>) => {
  ...
  return (
    <FormControl isInvalid={isInvalid} isDisabled={isDisabled} marginBottom="none">
      ...
      <TextInput.Group>
        <TextInput
          css={[hideCursorStyle, borderStyle, isDisabled ? disabledStyle : enabledStyle, isInvalid && invalidStyle]}
          value={inputValue}
          onClick={handleOpen}
