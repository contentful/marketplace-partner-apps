...
export type MenuContextType = {
  ...
  getMenuItemProps: (_props: ComponentPropsWithRef<'button'>) => ComponentPropsWithRef<'button'>;
  propsToPropagateToSubmenus: Pick<MenuProps, 'closeOnBlur' | 'closeOnEsc' | 'closeOnSelect'>;
};
