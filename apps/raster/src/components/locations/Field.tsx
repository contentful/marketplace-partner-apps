      ...
      {fieldValue?.length ? (
        <>
          {fieldValue.map((entry) => (
            <EntryCard
              ...
              description={
                entry.description
                  ? entry.description
                  : 'Description not available, but can be generated with our AI tool in Raster.'
              }
              thumbnailElement={
          ...
          <TextLink
            ...
            icon={<PlusIcon />}
            alignIcon='start'
            className='!text-primary !font-bold !mt-2.5 !w-fit !mx-auto'
            onClick={() => openDialog()}
          >
            Add more images
          </TextLink>
        ...
        <TextLink
          ...
          icon={<PlusIcon />}
          alignIcon='start'
          className='!text-primary !font-bold !w-fit !mx-auto'
          onClick={() => openDialog()}
        >
          Add Raster images
        </TextLink>
