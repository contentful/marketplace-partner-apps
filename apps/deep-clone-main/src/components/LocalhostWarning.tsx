...
const LocalhostWarning: React.FC = () => {
  return (
    <Flex marginTop="spacingXl" justifyContent="center">
      <Note title="App running outside of Contentful" style={{ maxWidth: '800px' }}>
        <Paragraph>
          ...
          <TextLink href="https://www.contentful.com/developers/docs/extensibility/ui-extensions/sdk-reference/#locations">available locations</TextLink>.
        </Paragraph>
        <br />
        ...
        <Paragraph>
          ...
          to get started or <TextLink href="https://app.contentful.com/deeplink?link=apps">open Contentful</TextLink> to manage your app.
        </Paragraph>
      </Note>
    </Flex>
  );
